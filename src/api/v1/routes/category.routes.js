...
import { createCategory, getAllCategories, getTrendingCategories, getBlogsByCategory, updateCategory, deleteCategory } from "../controllers/category.controller.js";
...
router.route("/trending").get(redisCache(300), getTrendingCategories);
